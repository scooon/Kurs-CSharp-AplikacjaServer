...
namespace WinSrv
{
    static class Display
    {
        ...
        public static void Rotate(uint DisplayNumber, int rotate)
        {
            switch (rotate)
            {
                case 0:
                    Rotate(DisplayNumber, Orientations.DEGREES_CW_0);
                    break;
                case 1:
                    Rotate(DisplayNumber, Orientations.DEGREES_CW_270);
                    break;
                case 2:
                    Rotate(DisplayNumber, Orientations.DEGREES_CW_180);
                    break;
                case 3:
                    Rotate(DisplayNumber, Orientations.DEGREES_CW_90);
                    break;
                default:
                    break;
            }
